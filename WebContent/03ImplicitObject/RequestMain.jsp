...
<body>
	...
	<!-- 
	Get방식에는 다음 3가지 형태의 전송방식이 있따.
	1. <a href=''를 사용하는 방법
	2. JS의 location.href=''를 사용하는 방법
	3. <form method='get'을 사용하는 방법
	 -->
	<h3>Get방식 전송</h3>
	<a href="RequestInfo.jsp?paramNum=123&paramEng=Hello&paramHan=안녕">Get 방식</a>
	...
	*/	
	...
	<form action="RequestParameter.jsp" method="post" name="regFrm"
		...
		<br />
		자기소개 :
			<textarea name="self_intro" cols="30" rows="10">나는 강하게 자랐다</textarea>
		<br />
			<input type="submit" value="post방식" />
	</form>		
