...
pageContext.setAttribute("pageMember2", 
		new MemberDTO("Taebal","1234","태바리",null));//생성자를 통해 초기화
...
<body>
	...
	*/
	...
	<ul>
		...
		<li>MemberDTO타입 1 : <%=m1Str %></li>
		<li>MemberDTO타입 2 : 아이디: <%=m2.getId() %>,
							비번: <%=m2.getPass()%>,
							이름: <%=m2.getName()%>,
	...
	<%--
		...
		발생되면 속성값이 모드 파괴되어 소멸된다. 즉 다른 페이지와는
		속성이 공유되지 않는다.
	 --%>
	<h2>페이지 이동</h2>
