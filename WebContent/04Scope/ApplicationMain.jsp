...
<body>
	...
	<h3>포워드로 페이지 전달하기</h3>
	<%
	/* 두가지 방법 모두 사용이 가능하다. 참조변수를 사용하냐 마냐의 차이 */
		request.getRequestDispatcher("ApplicationResult.jsp")
			.forward(request, response);
	/* 	RequestDispatcher dis =request.
			getRequestDispatcher("ApplicationResult.jsp");
		dis.forward(request, response); */
	%>
	<!-- 
		외부파일 인클루드 : include지시어를 통해 페이지를 상ㅂ입하면
