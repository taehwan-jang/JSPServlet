...
<body>
	...
	response.sendRedirect(request.getContextPath()+"/07ActionTag/ForwardActionResult.jsp");//정상이동
	*/
	...
	*/
 	...
 	페이지 이동을 알지 못한다.
 	-절대경로로 지정할 경우 Context root(컨택스트 루트)를 제외한
 	경로로 지정한다.
	...
	<!-- 
	3.포워드(액션태그를 사용한 예제)
	-액션태그의 page속성만 지정하면 되므로 표현이 간결하다.
	-나머지 특성은 모두 동일하다. 
	 -->
