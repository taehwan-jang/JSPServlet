<%--
	...
	지시어(Directive) : 페이지의 속성을 지정하거나 욈부문서를
...
<%--
	선언부(Declaration) : 스크립트릿이나 표현식에서 사용할
		메소드를 선언할때 사용한다. 함수는 재사용하기 위해 작성하는 사용하는
...
<body>
	...
	<br />
	<%
		//인수로 out내장객체를 전달하면, 메소드에서는 이를 통해
		//웹브라우저에 변수를 출력할 수 있다.
