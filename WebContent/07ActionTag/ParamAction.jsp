...
<%
/*
포워드된 페이지나 인크루드된 페이지로 파라미터를 전달하는 경우
한글이 포함되어 있다면, 반드시 포워드 시키는 최초페이지에서
인코딩을 설정해야 한다.
*/
request.setCharacterEncoding("UTF-8");
request.setAttribute("member", new MemberDTO("Jang","1234","태바리",null));
%>
<!DOCTYPE html>
<html>
<head>
...
<body> 
	...
	/*
		...
		공유되므로, 영역을 통해 데이터를 전달할 수 있따.
		차후 서블릿에서 활용되는 방식이다.
	*/
	request.setAttribute("member", new MemberDTO("kim","1222","김부부",null));
	%>
